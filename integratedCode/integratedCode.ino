...
#include "Bluetooth_vars.h" //Bluetooth variables
#include "Bluetooth_func.h" //Bluetooth functions
#include <Wire.h>
...
void toggleReady(int nothingMatters)
{
...
void loop() 
{
  Wire.onReceive(toggleReady);
	if (isReady) //INITIATE SEQUENCE
	{
    ...
    prevPulse = 400; //RESET VALUES
    newPulse = 400; //RESET PURPOSE
    toggleReady(3);
	}
}
